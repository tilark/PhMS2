...
{
    public class ImTotalAntibioticDdds : ITotalAntibioticDdds
    {
        private readonly IDomain2dot1InnerFactory innerFactory;
        public ImTotalAntibioticDdds(IDomain2dot1InnerFactory factory)
        {
            this.innerFactory = factory;
        }
        public decimal GetTotalAntibioticDdds(DateTime startTime, DateTime endTime)
        {
